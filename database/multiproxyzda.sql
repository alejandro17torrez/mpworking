...
-- Volcando datos para la tabla multipro.cargos: ~3 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla para almacenar los comprobantes de diario de las cooperativas de vivienda';

-- Volcando datos para la tabla multipro.comprobante_diario: ~4 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `cooperativa` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='tabla para almacenar las cooperativas de viviendas ';

-- Volcando datos para la tabla multipro.cooperativa: ~3 rows (aproximadamente)
...
INSERT INTO `cooperativa` (`id`, `nombre_cooperativa`, `resolucion_cooperativa`, `numero_ruc`, `created_at`) VALUES
	(80, 'multipro', '12345678', '1234561', '2019-12-13 02:44:45'),
	(81, 'solidaridad', '456671', '123453', '2019-12-13 02:44:45'),
	(85, 'San Carlos 123432', '12333221', '1523626', '2019-12-13 02:44:45');
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Amarre de todos los cocneptos a una o varias cuentas';
...
INSERT INTO `cuentas_cooperativas` (`id`, `cooperativa`, `cuenta`, `descripcion`, `saldo`, `create_at`) VALUES
	(8, 81, 93, '', 0, '2019-12-13 15:05:33'),
	(9, 81, 94, '', 0, '2019-12-13 15:05:35'),
	(10, 81, 95, '', 0, '2019-11-24 15:05:16'),
	(11, 81, 96, '', 0, '2019-12-13 15:05:29'),
	(12, 81, 97, '', 0, '2019-12-13 15:05:32'),
	(13, 81, 98, '', 0, '2019-12-13 15:05:28'),
	(14, 81, 99, '', 0, '2019-12-13 15:05:36'),
	(15, 81, 100, '', 0, '2019-12-10 13:30:20'),
	(16, 81, 101, '', 0, '2019-12-13 15:05:24'),
	(17, 81, 102, '1002056J', 0, '2019-12-13 15:05:26'),
	(18, 81, 102, '1013467A', 0, '2019-12-13 15:05:31'),
	(19, 81, 142, '', 0, '2019-11-27 16:31:45'),
	(20, 81, 143, '', 0, '2019-12-10 10:18:14'),
	(21, 81, 144, '', 0, '2019-11-27 16:32:21'),
	(22, 81, 145, '', 0, '2019-12-13 15:05:40'),
	(23, 81, 146, '', 0, '2019-12-13 15:05:42'),
	(24, 81, 147, '', 0, '2019-12-10 13:30:12'),
	(25, 81, 148, '', 0, '2019-12-10 13:30:14'),
	(27, 81, 131, '', 0, '2019-12-10 10:18:10'),
	(28, 81, 132, '', 0, '2019-12-10 10:18:07'),
	...
	(57, 81, 112, '', 0, '2019-12-13 15:05:37'),
	(58, 81, 113, '', 0, '2019-12-13 15:05:38'),
...
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla para almacenar los movimientos de las cuentas dentro del comprobante\nde diario.';

-- Volcando datos para la tabla multipro.movimientos: ~14 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla para almacenar los recibos de egresos de las cooperativas de viviendas';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla para recepcionar recibos de ingresos';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla donde se administran los socios de cada cooperativa';

-- Volcando datos para la tabla multipro.socios: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla multipro.tipo_cuenta: ~5 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `password`, `id_cooperativa`, `usuario`, `created_at`) VALUES
	(6, '123', 80, 'admin', '2019-12-13 02:45:17'),
	(8, '456', 81, 'soli', '2019-12-13 02:45:17');
